import{u as d,a as l,b as f}from"./vendor-query-B4NGzH15.js";import{s,a as m}from"./index-D8O7H1g5.js";import{z as a}from"./AuthenticatedApp-CIsH_cVu.js";const _=async t=>{if(!t)return[];const{data:e,error:r}=await s.from("contacts").select(`
      *,

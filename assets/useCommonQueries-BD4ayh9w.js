import{u as d,a as l,b as f}from"./vendor-query-Dtl2yJ2N.js";import{s,a as m}from"./index-KQiMsmg-.js";import{z as a}from"./AuthenticatedApp-BL-wYs41.js";const _=async t=>{if(!t)return[];const{data:e,error:r}=await s.from("contacts").select(`
      *,

import{c as m,d as y,r as p,j as t}from"./index-C_M-QvSZ.js";const h=({onComplete:i})=>{const s=m(),{isDark:c}=y(),r=c,a=r?"#25D366":"#00a884";return p.useEffect(()=>{const n=setTimeout(()=>{const e=new URLSearchParams(window.location.search).get("redirect");s(e==="login"?"/login":"/"),i()},3e3);return()=>clearTimeout(n)},[s,i]),t.jsxs("div",{className:`intro-overlay transition-colors duration-500 overflow-hidden

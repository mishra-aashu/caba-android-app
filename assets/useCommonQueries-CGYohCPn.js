import{u as d,a as l,b as f}from"./vendor-query-q4DByiy6.js";import{s,b as m}from"./index-C4rCwRPG.js";import{z as a}from"./AuthenticatedApp-CpNT_HxR.js";const _=async t=>{if(!t)return[];const{data:e,error:r}=await s.from("contacts").select(`
      *,

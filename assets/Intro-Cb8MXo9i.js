import{j as t}from"./vendor-ui-DRlN_Dxo.js";import{u as p,k as y,r as x}from"./vendor-react-B-GH-4VX.js";import{c as h}from"./index-D98h8cyo.js";import"./vendor-supabase-BZ0N5lZN.js";import"./vendor-query-pyZ3i4Kq.js";const j=({onComplete:o})=>{const s=p(),[c]=y(),{isDark:m}=h(),r=m,a=r?"#25D366":"#00a884";return x.useEffect(()=>{const i=setTimeout(()=>{const e=c.get("redirect");s(e==="login"?"/login":"/"),o()},3e3);return()=>clearTimeout(i)},[s,o]),t.jsxs("div",{className:`intro-overlay transition-colors duration-500 overflow-hidden

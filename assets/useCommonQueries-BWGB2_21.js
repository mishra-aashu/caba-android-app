import{u as d,a as l,b as f}from"./vendor-query-D4pr0uHB.js";import{s,a as m}from"./index-DsgwQgpW.js";import{z as a}from"./AuthenticatedApp-BTJD3r7H.js";const _=async t=>{if(!t)return[];const{data:e,error:r}=await s.from("contacts").select(`
      *,

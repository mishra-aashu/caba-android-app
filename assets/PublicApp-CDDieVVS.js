const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CRlaQaV1.js","assets/vendor-ui-C9SKRs7W.js","assets/vendor-react-BcsPgoup.js","assets/vendor-supabase-BZ0N5lZN.js","assets/vendor-query-BQ1Yi_ak.js","assets/index-D_zN1tUP.css","assets/LandingPage-BAyy5r7z.js","assets/AppName-qxkHKfGg.js","assets/AppName-BbtBD1tR.css","assets/LandingPage-CUIbdkj0.css","assets/Login-CcAS82qA.js","assets/Login-BKTjdBs-.css","assets/DownloadAPK-D2KsygEy.js","assets/useAppVersions-4TGRfM66.js","assets/Terms-Hfce-xzX.js","assets/Privacy-DGt31oRc.js","assets/About-BRfeBfYH.js","assets/versionUtils-C1D8PNZp.js","assets/About-BNHYYKvc.css","assets/AuthenticatedApp-DtsO-31I.js","assets/AuthenticatedApp-CGHs7U8B.css"])))=>i.map(i=>d[i]);
import{C as B,_ as j,f as J,o as ee,c as te}from"./index-CRlaQaV1.js";import{j as c,a as ae,m as se,w as re,b1 as oe,X as ie}from"./vendor-ui-C9SKRs7W.js";import{r as o,b as ne,N as H,d as le,e as N}from"./vendor-react-BcsPgoup.js";const ce=300*1e3,de=4e3,ue=5e3,F="ota-target-url",S="ota-just-refreshed",z="https://caba-android-app.vercel.app",me=()=>{const[e,t]=o.useState(!1),[a,r]=o.useState(!1),[i,n]=o.useState(!1),s=o.useRef(null),l=o.useRef(null),d=o.useRef(Date.now()),p=o.useRef(!1),m=o.useRef(B.isNativePlatform());o.useEffect(()=>{const b=document.querySelector('meta[name="build-time"]')?.content||null;if(s.current=b,!b)console.error(`[AutoRefresh] ❌ CRITICAL: <meta name="build-time"> not found!

import{a as y,a2 as p,R as x,r as h,j as t}from"./index-CA84I5Mb.js";const b=({onComplete:o})=>{const s=y(),[c]=p(),{isDark:f}=x(),r=f,a=r?"#25D366":"#00a884";return h.useEffect(()=>{const i=setTimeout(()=>{const e=c.get("redirect");s(e==="login"?"/login":"/"),o()},3e3);return()=>clearTimeout(i)},[s,o]),t.jsxs("div",{className:`intro-overlay transition-colors duration-500 overflow-hidden

import{u as d,a as l,b as f}from"./vendor-query-DwTHDPpq.js";import{s,b as m}from"./index-D29RPhvl.js";import{z as a}from"./AuthenticatedApp-D47ly3RQ.js";const _=async t=>{if(!t)return[];const{data:e,error:r}=await s.from("contacts").select(`
      *,

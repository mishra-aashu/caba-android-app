import{u as d,a as l,b as f}from"./vendor-query-DwTHDPpq.js";import{s,b as m}from"./index-DEaon95E.js";import{z as a}from"./AuthenticatedApp-B8IPAM6H.js";const _=async t=>{if(!t)return[];const{data:e,error:r}=await s.from("contacts").select(`
      *,

...
to {
  ...
  animation: ${Ue} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Fe=({toast:e})=>{let{icon:t,type:a,iconTheme:r}=e;return t!==void 0?typeof t=="string"?o.createElement(He,null,t):t:a==="blank"?null:o.createElement(Ve,null,o.createElement($e,{...r}),a!=="loading"&&o.createElement(We,null,a==="error"?o.createElement(Ie,{...r}):o.createElement(ze,{...r})))},Me=e=>`
...
`,Ze=(e,t)=>{let a=e.includes("top")?1:-1,[r,i]=G()?[Ke,Ye]:[Me(a),Be(a)];return{animation:t?`${E(r)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${E(i)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},Je=o.memo(({toast:e,position:t,style:a,children:r})=>{let i=e.height?Ze(e.position||t||"top-center",e.visible):{opacity:0},n=o.createElement(Fe,{toast:e}),s=o.createElement(qe,{...e.ariaProps},$(e.message,e));return o.createElement(Ge,{className:e.className,style:{...i,...a,...e.style}},typeof r=="function"?r({icon:n,message:s}):o.createElement(o.Fragment,null,n,s))});we(o.createElement);var Qe=({id:e,className:t,style:a,onHeightUpdate:r,children:i})=>{let n=o.useCallback(s=>{if(s){let l=()=>{let d=s.getBoundingClientRect().height;r(e,d)};l(),new MutationObserver(l).observe(s,{subtree:!0,childList:!0,characterData:!0})}},[e,r]);return o.createElement("div",{ref:n,className:t,style:a},i)},Xe=(e,t)=>{let a=e.includes("top"),r=a?{top:0}:{bottom:0},i=e.includes("center")?{justifyContent:"center"}:e.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:G()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${t*(a?1:-1)}px)`,...r,...i}},et=L`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,I=16,tt=({reverseOrder:e,position:t="top-center",toastOptions:a,gutter:r,children:i,toasterId:n,containerStyle:s,containerClassName:l})=>{let{toasts:d,handlers:p}=Ne(a,n);return o.createElement("div",{"data-rht-toaster":n||"",style:{position:"fixed",zIndex:9999,top:I,left:I,right:I,bottom:I,pointerEvents:"none",...s},className:l,onMouseEnter:p.startPause,onMouseLeave:p.endPause},d.map(m=>{let u=m.position||t,g=p.calculateOffset(m,{reverseOrder:e,gutter:r,defaultPosition:t}),v=Xe(u,g);return o.createElement(Qe,{id:m.id,key:m.id,onHeightUpdate:p.updateHeight,className:m.visible?et:"",style:v},m.type==="custom"?$(m.message,m):i?i(m):o.createElement(Je,{toast:m,position:u}))}))},pt=y;const at=o.lazy(()=>j(()=>import("./LandingPage-VHjA-bup.js"),__vite__mapDeps([6,1,2,0,3,4,5,7,8,9]))),st=o.lazy(()=>j(()=>import("./Login-B_q895Jb.js"),__vite__mapDeps([10,1,2,0,3,4,5,7,8,11]))),rt=o.lazy(()=>j(()=>import("./DownloadAPK-CY-o8maA.js"),__vite__mapDeps([12,1,2,13,4,0,3,5]))),ot=o.lazy(()=>j(()=>import("./Terms-Hfce-xzX.js"),__vite__mapDeps([14,1,2]))),it=o.lazy(()=>j(()=>import("./Privacy-DGt31oRc.js"),__vite__mapDeps([15,1,2]))),nt=o.lazy(()=>j(()=>import("./About-Ba90wsDG.js"),__vite__mapDeps([16,1,2,13,4,0,3,5,17,7,8,18]))),lt=o.lazy(()=>j(()=>import("./AuthenticatedApp-61nNKH80.js").then(e=>e.A),__vite__mapDeps([19,0,1,2,3,4,5,7,8,20]))),ct=()=>{const{isAuthenticated:e,loading:t}=te(),{needsRefresh:a,handleRefresh:r,handleDismiss:i,isRefreshing:n}=me(),s=ne();if(t)return c.jsx("div",{className:"loading-screen"});const l=B.isNativePlatform();return!e&&l&&s.pathname==="/"?c.jsx(H,{to:"/login",replace:!0}):c.jsxs(c.Fragment,{children:[c.jsx(o.Suspense,{fallback:c.jsx("div",{className:"loading"}),children:e?c.jsx(lt,{}):c.jsxs(le,{children:[c.jsx(S,{path:"/",element:c.jsx(at,{})}),c.jsx(S,{path:"/login",element:c.jsx(st,{})}),c.jsx(S,{path:"/download-apk",element:c.jsx(rt,{})}),c.jsx(S,{path:"/terms",element:c.jsx("div",{className:"legal-page-wrapper",children:c.jsx(ot,{})})}),c.jsx(S,{path:"/privacy",element:c.jsx("div",{className:"legal-page-wrapper",children:c.jsx(it,{})})}),c.jsx(S,{path:"/about",element:c.jsx(nt,{})}),c.jsx(S,{path:"*",element:c.jsx(H,{to:"/",replace:!0})})]})}),c.jsx(pe,{needsRefresh:a,isRefreshing:n,handleRefresh:r,handleDismiss:i}),c.jsx(tt,{position:"bottom-center",toastOptions:{duration:3500,className:"premium-toast",success:{className:"premium-toast premium-toast-success",iconTheme:{primary:"var(--brand-primary)",secondary:"#fff"}},error:{className:"premium-toast premium-toast-error",iconTheme:{primary:"var(--error-color)",secondary:"#fff"}},loading:{className:"premium-toast premium-toast-loading"},style:{background:"transparent",boxShadow:"none",border:"none"}},containerStyle:{bottom:"calc(75px + var(--sab, 0px))"}})]})},ft=Object.freeze(Object.defineProperty({__proto__:null,default:ct},Symbol.toStringTag,{value:"Module"}));export{ft as P,y as n,me as u,pt as z};

import{u as d,a as l,b as f}from"./vendor-query-BEKeVR66.js";import{s,b as m}from"./index-CK0M4EG7.js";import{z as a}from"./AuthenticatedApp-WTAFH8nI.js";const _=async t=>{if(!t)return[];const{data:e,error:r}=await s.from("contacts").select(`
      *,

import{u as d,a as l,b as f}from"./vendor-query-B4NGzH15.js";import{s,a as m}from"./index-BouSykWo.js";import{z as a}from"./AuthenticatedApp-Ct4rhgcQ.js";const _=async t=>{if(!t)return[];const{data:e,error:r}=await s.from("contacts").select(`
      *,

import{u as d,a as l,b as f}from"./vendor-query-Dtl2yJ2N.js";import{s,a as m}from"./index-B7Dz6te1.js";import{z as a}from"./AuthenticatedApp-PnJY8E2A.js";const _=async t=>{if(!t)return[];const{data:e,error:r}=await s.from("contacts").select(`
      *,

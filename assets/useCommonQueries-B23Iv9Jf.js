import{u as d,a as l,b as f}from"./vendor-query-Dtl2yJ2N.js";import{s,a as m}from"./index-7X48NKRI.js";import{z as a}from"./AuthenticatedApp-D-CjAgf-.js";const _=async t=>{if(!t)return[];const{data:e,error:r}=await s.from("contacts").select(`
      *,

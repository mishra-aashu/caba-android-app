...
export default async function handler(req, res) {
  ...
  try {
    const recsUrl = `https://www.jiosaavn.com/api.php?__call=recommender.getAssetReccomendation&_format=json&_marker=0&ctx=web64bit&api_version=4&type=song&id=${id}`;

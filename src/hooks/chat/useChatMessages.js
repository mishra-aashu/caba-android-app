...
export function useChatMessages({
    ...
    const messages = useMemo(() => {
        ...
        // pages arrive newest-first. Reverse to chronological for UI.
        ...
        queryClient.setQueryData(['messages', chatId], (old) => {
            ...
            return {
                ...
                pages: old.pages.map(page => ({
                    ...page,
                    data: page.data.map(m => idSet.has(m.id) ? { ...m, is_deleted: true, isDeleted: true } : m)
                }))
            };
        });
        ...
        try {
            ...
            queryClient.setQueryData(['messages', chatId], (old) => {
                ...
                return {
                    ...
                    pages: old.pages.map(page => ({
                        ...page,
                        data: page.data.map(msg => msg.tempId === tempId ? finalMsg : msg)
                    }))
                };
            });
    ...
    }, [chatId, otherUserId, isGroupChat, isNewChat, currentUser, replyingTo, supabase, queryClient, navigate]);
